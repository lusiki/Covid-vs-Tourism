---
title: "COVID-19 pandemic and tourist sector in Croatia"
...
.footnote[ [*]The analysis is avaliable as [The effect of COVID-19 pandemic on Croatian tourist sector](https://raw.githack.com/lusiki/Covid-vs-Tourism/main/Covid-vs-Tourism-PAPER.html) and all supporting code, data and materials are OpenSourc-ed on [Github](https://github.com/lusiki/Covid-vs-Tourism).]
...
- Huge research on COVID-19 economics (check: [1](https://cepr.org/content/covid-economics-vetted-and-real-time-papers-0),[2](https://voxeu.org/debates/economics-time-covid-19), [3](https://www.oxfordeconomics.com/coronavirus),
...
[3](https://www.europarl.europa.eu/RegData/etudes/STUD/2021/662903/IPOL_STU(2021)662903_EN.pdf)
<br>
<br>
- Impact of COVID-19 pandemic on SEE (check: [1](https://wiiw.ac.at/brave-new-world-the-economic-and-political-challenges-facing-eastern-europe-after-covid-19-e-517.html),
...
- [1](https://www.unwto.org/tourism-and-covid-19-unprecedented-economic-impacts),
- [3](https://www.sciencedirect.com/science/article/pii/S2666518221000206),
- [4](https://mpra.ub.uni-muenchen.de/107784/1/MPRA_paper_107784.pdf))
...
# General market (CROBEX)
<br>
<br>

```{r, echo=FALSE, fig.height=5}
knitr::include_url("https://zse.hr/en/indeks-366/365?isin=HRZB00ICBEX6")
```
---
...
<br>
```{r, echo=FALSE}
knitr::include_url("https://zse.hr/en/indeks-366/365?isin=HRZB00ICBEI7")
```
...
<br>
```{r, echo=FALSE}
knitr::include_url("https://zse.hr/en/indeks-366/365?isin=HRZB00ICBEK3")
```
...
<br>
```{r, echo=FALSE}
knitr::include_url("https://zse.hr/en/indeks-366/365?isin=HRZB00ICBEN7")
```
...
<br>
```{r, echo=FALSE}
knitr::include_url("https://zse.hr/en/indeks-366/365?isin=HRZB00ICBET4")
```
...
<br>
```{r, echo=FALSE}
knitr::include_url("https://zse.hr/en/indeks-366/365?isin=HRZB00ICBTU0")
```
...
.[footnote [*]Check the [paper](https://www.researchgate.net/publication/309300600_Tourism_Sector_on_the_Zagreb_Stock_Exchange_ZSE_What_is_the_Value_of_Croatian_Tourism) on the valuation of Croatian tourist stocks.]
---
