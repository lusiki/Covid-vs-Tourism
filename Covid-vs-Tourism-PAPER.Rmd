...
The evidence of significant positive or negative abnormal returns is expected if the markets reaction to the event efficiently incorporates avaliable information. The analysis examines the Croatian stock market reaction to the announcement of first reported COVID-19 pandemic incidence in Italy. Since the pandemic was gaining momentum worldwide and it was  highly anticipated by investors that it will spread into the Europe, we set the event day one week prior to the fist officially reported case in Italy. The Abnormal returns ($AR$ ) for index i at day t is calculated as in equation (1):
