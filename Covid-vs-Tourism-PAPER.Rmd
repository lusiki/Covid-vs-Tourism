...
The historical stock price average $\bar{R_{i,t}}$ is calculated over the period from from the first trading day of the 2019. until the event. The daily returns ($R_{i,t}$) are calculated according to the:
